export const MARKET_ASSETS = [
  ...
  },
  {
    ...
    chartType: 'price',
    explanation:
      'Daily QQQ ETF history used as a free Nasdaq 100 proxy.',
    sourceLabel: 'Stooq / QQQ ETF proxy',
  },
  {
    id: 'russell2000',
    ...
    symbol: 'IWM',
    provider: 'stooq',
    providerSymbol: 'iwm.us',
    chartType: 'price',
    explanation:
      'Daily IWM ETF history used as a free small-cap proxy.',
    sourceLabel: 'Stooq / IWM ETF proxy',
  },
  {
    id: 'eafe',
    ...
    symbol: 'EFA',
    provider: 'stooq',
    providerSymbol: 'efa.us',
    chartType: 'price',
    explanation:
      'Daily EFA ETF history used as a free developed-markets proxy.',
    sourceLabel: 'Stooq / EFA ETF proxy',
  },
  {
    id: 'gold',
    name: 'Gold / GLD Proxy',
    ...
    chartType: 'price',
    explanation:
      'Daily GLD ETF history used as a free gold proxy.',
    sourceLabel: 'Stooq / GLD ETF proxy',
  },
  {
    id: 'copper',
    name: 'Copper',
